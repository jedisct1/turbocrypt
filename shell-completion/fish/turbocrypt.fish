set -l cmds 'keygen' 'change-password' 'encrypt' 'decrypt' 'verify' 'list' 'config' 'git' 'mount' 'unmount' 'bench' 'version' 'init'

complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' --no-files -a keygen -d "Generate a new key"
...
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' --no-files -a mount -d "Show an encrypted directory as a normal one"
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' --no-files -a unmount -d "Unmount a mounted directory"
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' --no-files -a init -d "Create an empty container for mount"
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' --no-files -a bench -d "Run performance benchmarks"
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' --no-files -a version -d "Show the program version"

complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' -l help -s h -d "Show help"
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from git; and not __fish_seen_subcommand_from mount; and not __fish_seen_subcommand_from unmount; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version; and not __fish_seen_subcommand_from init' -l version -s V -d "Show the program version"
...
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l key -r -a '(__fish_complete_path)' -d "Path to key file"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l password -d "Use password-protected key (prompt)"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l context --no-files -r -d "Context string"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l encrypted-filenames -d "The encrypted directory has encrypted names"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l enc-suffix -d "Files in the encrypted directory carry .enc"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l read-only -d "Refuse every change"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l daemon -d "Return once the volume is mounted"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l single-thread -d "Serve one request at a time"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l debug -d "Print diagnostics"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l volname --no-files -r -d "Volume name"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l allow-other -d "Serve other users"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l max-file-size --no-files -r -d "Largest file that can be opened (bytes)"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l memory-limit --no-files -r -d "Budget for all open files (bytes)"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l rescue-dir -r -a '(__fish_complete_directories)' -d "Where unwritable files go at unmount"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -l force -d "Skip the key check"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -s o --no-files -r -d "A libfuse or fuse-t option"
complete -c turbocrypt -n '__fish_seen_subcommand_from mount' -a '(__fish_complete_directories)' -d "Encrypted directory, then mountpoint"
complete -c turbocrypt -n '__fish_seen_subcommand_from unmount' -a '(__fish_complete_directories)' -d "Mountpoint"

complete -c turbocrypt -n '__fish_seen_subcommand_from init' -l key -r -a '(__fish_complete_path)' -d "Path to key file"
complete -c turbocrypt -n '__fish_seen_subcommand_from init' -l password -d "Use password-protected key (prompt)"
complete -c turbocrypt -n '__fish_seen_subcommand_from init' -l context --no-files -r -d "Context string"
complete -c turbocrypt -n '__fish_seen_subcommand_from init' -l encrypted-filenames -d "Encrypt the names in the container"
complete -c turbocrypt -n '__fish_seen_subcommand_from init' -l enc-suffix -d "Give the files in the container a .enc suffix"
complete -c turbocrypt -n '__fish_seen_subcommand_from init' -a '(__fish_complete_directories)' -d "Container directory"
