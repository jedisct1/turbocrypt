...
set -l cmds 'keygen' 'change-password' 'encrypt' 'decrypt' 'verify' 'list' 'config' 'bench' 'version'
...
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version' --no-files -a keygen -d "Generate a new key"
...
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version' -l help -s h -d "Show help"
complete -c turbocrypt -n 'not __fish_seen_subcommand_from keygen; and not __fish_seen_subcommand_from change-password; and not __fish_seen_subcommand_from encrypt; and not __fish_seen_subcommand_from decrypt; and not __fish_seen_subcommand_from verify; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from config; and not __fish_seen_subcommand_from bench; and not __fish_seen_subcommand_from version' -l version -s V -d "Show the program version"
