...
complete -c turbocrypt -n '__fish_seen_subcommand_from git; and __fish_seen_subcommand_from init' -l key -r -d "Import an existing key file"
...
complete -c turbocrypt -n '__fish_seen_subcommand_from git; and __fish_seen_subcommand_from unlock' -a '(__fish_complete_path)' -d "Key file"
